...
PRIVATE int swap_in(unsigned frame, addr_t addr)
{
    ...
    pg->accessed = 0;
    pg->dirty = 0;      // página na memória principal em conforme com o disco
    pg->referenced = 1; // página foi referenciada
